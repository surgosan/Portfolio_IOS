...
struct Home: View {
    ...
    let socialsData: [SocialLinkDetails] = [
            ...
            SocialLinkDetails(urlString: "https://www.linkedin.com/in/sergio-sanchez-alvares-36a97614a/", buttonText: "Connect on LinkedIn", imageName: "LinkedIn", backgroundColor: Color.red),
            
            SocialLinkDetails(urlString: "https://sanchezalvarez.dev/", buttonText: "View this Site", imageName: "S", backgroundColor: Color.green),
